	...
	app.init = function() {
		...
		$("#payBtn").on("click", function() {
			if(!$(this).hasClass("btn_disable") && isHaveOpenId) {
                if((app.UrlParams.payway==30 && app.UrlParams.type == 10) || (app.UrlParams.payway==30 && app.UrlParams.type == 3) || (app.UrlParams.payway==30 && app.UrlParams.type == 4)){
					app.replace("zzpaysuccess.html" + location.search);
					return;
			    }else if(app.UrlParams.payway == 30) { //货到付款

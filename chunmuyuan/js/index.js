//首页
define(["base/baseApp", "../lib/aui/script/aui-slide", "animate","base/baseCar"], function(app, slide, animate,baseCar) {
...
//   app.yyActivityGo = function () {
//      if(!app.checkLogin()){
//          app.replace("./html/login.html");
//          return;
//		}
//  }

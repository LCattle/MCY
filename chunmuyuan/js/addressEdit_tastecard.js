//地址编辑
define(["base/baseApp", '../lib/citySelector/lArea', '../lib/citySelector/address_tastecard', './base/validate', 'animate', 'css!../lib/citySelector/lArea'], function(app, area, address, validate, animate) {

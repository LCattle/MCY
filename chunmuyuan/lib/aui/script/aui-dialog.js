...
(function( window, undefined ) {
    ...
    auiDialog.prototype = {
        ...
        create: function(params,callback,isCloseCustom) {
        	var self = this;
            var dialogHtml = '';
            var buttonsHtml = '';
        ...
        prompt:function(params,callback,isCloseCustom){
            var self = this;
            params.input = true;
            return self.create(params,callback,isCloseCustom);
        }
    };

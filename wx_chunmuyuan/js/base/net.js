define([], function() {
	...
	net.netConfig = {
		...
		//商城服务host前缀
		server: {
			dev: "http://test.springwoods.com/ctower-mall/",
			test: "http://112.74.57.203/ctower-mall/",
			release: "",
			my:"http://192.168.5.171/ctower-mall-c/"
		},
		//基础服务host前缀
		server_i: {
			...
			release: "",
            my:"http://112.74.57.203/ctower-mall-i/"
		},
		//会员服务host前缀
		server_m: {
			...
			release: "",
            my:"http://192.168.5.171/ctower-mall-m/"
		},
		//商品详情页面数据地址
		server_d: {
			...
			release: "",
            my:"http://112.74.57.203/static_detail/"
		},
		...
		imgServer: {
			...
			release: "",
            my:"http://112.74.57.203/uploaded/image"
		}
	};
	//获取图片路径
